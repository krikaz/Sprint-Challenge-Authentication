...
So the user doesn't have to login everytime he clicks an url.

1. What does bcrypt do to help us store passwords in a secure manner.

It hashes the passwords so they are not store in plain text.

1. What does bcrypt do to slow down attackers?

It uses a slow hashing algorithms so if attackers try to brute force the password, it will take a long time.
